(function () {
    ...
    ControllerController.$inject = ['$scope', '$rootScope', '$filter', 'userService', 'JobsService', 'locationService', 'skillsService'];
    function ControllerController($scope, $rootScope, $filter, userService, JobsService, locationService, skillsService) {
        ...
        // vm.startInitMap = function (jobs) {
        //     $scope.$broadcast('initMap', jobs);
        // }
        ...
        vm.getUserDetails = function () {
            ...
            return userService.getUserDetails().then((res) => {
                var user = res.data;
                $scope.userLoction = { 'lat': user.lat, 'lng': user.lon }
                // localStorage.setItem('userLocation', userLoction)
        ...
        $scope.distFilter = function (limDist) {
            ...
            // var userLat = localStorage.getItem('userLocation').lat;
            // var userLon = localStorage.getItem('userLocation').lon;
            // var userCord = { 'lat': $scope.userLoction.lat, 'lng':$scope.userLoction.lon };
